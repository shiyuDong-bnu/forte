...
void SADSRG::H2_T2_C2_sym(BlockedTensor& H2,BlockedTensor& H2_sym, BlockedTensor& T2, BlockedTensor& S2, const double& alpha,
    ...
    C2["ijrs"] -= 0.5 * alpha * L1_["xy"] * T2["ijxb"] * H2["ybrs"];
        // C2["i,j,a3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,a3,a2,"];//aaaa
        // C2["i,j,a3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,a3,v2,"];//aaav
        // C2["i,j,v3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,a2,v3,"];//aaav****
        // C2["i,j,c3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,a2,"];//aaca
        // C2["i,j,a3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,c2,a3,"];//aaca****
        // C2["i,j,c3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,c2,"];//aacc
        // C2["i,j,c3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,v2,"];//aacv
        // C2["i,j,v3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,c2,v3,"];//aacv****
        // C2["i,j,v3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,v3,v2,"];//aavv
        // C2["i,j,a3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,a2,"];//avaa
        // C2["i,j,a3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,c2,"];//avac
        // C2["i,j,a3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,v2,"];//avav
        // C2["i,j,c3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,a2,"];//avca
        // C2["i,j,c3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,c2,"];//avcc
        // C2["i,j,c3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,v2,"];//avcv
        // C2["i,j,v3,a2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,a2,"];//avva
        // C2["i,j,v3,c2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,c2,"];//avvc
        // C2["i,j,v3,v2,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,v2,"];//avvv
    C2["jisr"] -= 0.5 * alpha * L1_["xy"] * T2["ijxb"] * H2["ybrs"];
        // C2["j,i,a2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,a3,a2,"];//aaaa
        // C2["j,i,v2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,a3,v2,"];//aaav
        // C2["j,i,a2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,a2,v3,"];//aaav****
        // C2["j,i,a2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,a2,"];//aaca
        // C2["j,i,c2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,c2,a3,"];//aaca****
        // C2["j,i,c2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,c2,"];//aacc
        // C2["j,i,v2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,c3,v2,"];//aacv
        // C2["j,i,c2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a4,a8,c2,v3,"];//aacv****
        // C2["j,i,v2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,a4,"] * H2_sym["a8,a4,v3,v2,"];//aavv
        // C2["j,i,a2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,a2,"];//avaa
        // C2["j,i,c2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,c2,"];//avac
        // C2["j,i,v2,a3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,a3,v2,"];//avav
        // C2["j,i,a2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,a2,"];//avca
        // C2["j,i,c2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,c2,"];//avcc
        // C2["j,i,v2,c3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,c3,v2,"];//avcv
        // C2["j,i,a2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,a2,"];//avva
        // C2["j,i,c2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,c2,"];//avvc
        // C2["j,i,v2,v3,"] -= 0.5 * alpha * L1_["x,a8,"] * T2["i,j,x,v4,"] * H2_sym["a8,v4,v3,v2,"];//avvv
    // hole-hole contractions
    C2["pqab"] += alpha * H2["pqij"] * T2["ijab"];
            // C2["a2,a3,a,b,"] += alpha * H2_sym["a2,a3,a9,a1,"] * T2["a9,a1,a,b,"];//aaaa
            // C2["a2,a3,a,b,"] += alpha * H2_sym["a2,a3,c9,a1,"] * T2["c9,a1,a,b,"];//aaca
            // C2["a2,a3,a,b,"] += alpha * H2_sym["a3,a2,c1,a9,"] * T2["a9,c1,a,b,"];//aaca****
            // C2["a2,a3,a,b,"] += alpha * H2_sym["a2,a3,c9,c1,"] * T2["c9,c1,a,b,"];//aacc
            // C2["a2,v3,a,b,"] += alpha * H2_sym["a2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//avaa
            // C2["v2,a3,a,b,"] += alpha * H2_sym["a3,v2,a1,a9,"] * T2["a9,a1,a,b,"];//avaa****
            // C2["a2,v3,a,b,"] += alpha * H2_sym["a2,v3,a9,c1,"] * T2["a9,c1,a,b,"];//avac
            // C2["v2,a3,a,b,"] += alpha * H2_sym["a3,v2,a1,c9,"] * T2["c9,a1,a,b,"];//avac****
            // C2["a2,v3,a,b,"] += alpha * H2_sym["a2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//avca
            // C2["v2,a3,a,b,"] += alpha * H2_sym["a3,v2,c1,a9,"] * T2["a9,c1,a,b,"];//avca****
            // C2["a2,v3,a,b,"] += alpha * H2_sym["a2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//avcc
            // C2["v2,a3,a,b,"] += alpha * H2_sym["a3,v2,c1,c9,"] * T2["c9,c1,a,b,"];//avcc****
            // C2["c2,a3,a,b,"] += alpha * H2_sym["c2,a3,a9,a1,"] * T2["a9,a1,a,b,"];//caaa
            // C2["a2,c3,a,b,"] += alpha * H2_sym["c3,a2,a1,a9,"] * T2["a9,a1,a,b,"];//caaa****
            // C2["c2,a3,a,b,"] += alpha * H2_sym["c2,a3,a9,c1,"] * T2["a9,c1,a,b,"];//caac
            // C2["a2,c3,a,b,"] += alpha * H2_sym["c3,a2,a1,c9,"] * T2["c9,a1,a,b,"];//caac****
            // C2["c2,a3,a,b,"] += alpha * H2_sym["c2,a3,c9,a1,"] * T2["c9,a1,a,b,"];//caca
            // C2["a2,c3,a,b,"] += alpha * H2_sym["c3,a2,c1,a9,"] * T2["a9,c1,a,b,"];//caca****
            // C2["c2,a3,a,b,"] += alpha * H2_sym["c2,a3,c9,c1,"] * T2["c9,c1,a,b,"];//cacc
            // C2["a2,c3,a,b,"] += alpha * H2_sym["c3,a2,c1,c9,"] * T2["c9,c1,a,b,"];//cacc****
            // C2["c2,c3,a,b,"] += alpha * H2_sym["c2,c3,a9,a1,"] * T2["a9,a1,a,b,"];//ccaa
            // C2["c2,c3,a,b,"] += alpha * H2_sym["c2,c3,c9,a1,"] * T2["c9,a1,a,b,"];//ccca
            // C2["c2,c3,a,b,"] += alpha * H2_sym["c3,c2,c1,a9,"] * T2["a9,c1,a,b,"];//ccca****
            // C2["c2,c3,a,b,"] += alpha * H2_sym["c2,c3,c9,c1,"] * T2["c9,c1,a,b,"];//cccc
            // C2["c2,v3,a,b,"] += alpha * H2_sym["c2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//cvaa
            // C2["v2,c3,a,b,"] += alpha * H2_sym["c3,v2,a1,a9,"] * T2["a9,a1,a,b,"];//cvaa****
            // C2["c2,v3,a,b,"] += alpha * H2_sym["c2,v3,a9,c1,"] * T2["a9,c1,a,b,"];//cvac
            // C2["v2,c3,a,b,"] += alpha * H2_sym["c3,v2,a1,c9,"] * T2["c9,a1,a,b,"];//cvac****
            // C2["c2,v3,a,b,"] += alpha * H2_sym["c2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//cvca
            // C2["v2,c3,a,b,"] += alpha * H2_sym["c3,v2,c1,a9,"] * T2["a9,c1,a,b,"];//cvca****
            // C2["c2,v3,a,b,"] += alpha * H2_sym["c2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//cvcc
            // C2["v2,c3,a,b,"] += alpha * H2_sym["c3,v2,c1,c9,"] * T2["c9,c1,a,b,"];//cvcc****
            // C2["v2,v3,a,b,"] += alpha * H2_sym["v2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//vvaa
            // C2["v2,v3,a,b,"] += alpha * H2_sym["v2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//vvca
            // C2["v2,v3,a,b,"] += alpha * H2_sym["v3,v2,c1,a9,"] * T2["a9,c1,a,b,"];//vvca****
            // C2["v2,v3,a,b,"] += alpha * H2_sym["v2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//vvcc
    C2["pqab"] -= 0.5 * alpha * Eta1_["xy"] * T2["yjab"] * H2["pqxj"];
    ...
    auto temp = ambit::BlockedTensor::build(tensor_type_, "temp", blocks);
    temp["qjsb"] += alpha * H2["aqms"] * S2["mjab"];
        // temp["a3,j,a2,b,"] += alpha * H2_sym["a5,a3,c6,a2,"] * S2["c6,j,a5,b,"];//aaca
        // temp["a3,j,c2,b,"] += alpha * H2_sym["a5,a3,c6,c2,"] * S2["c6,j,a5,b,"];//aacc
        // temp["a3,j,v2,b,"] += alpha * H2_sym["a5,a3,c6,v2,"] * S2["c6,j,a5,b,"];//aacv
        // temp["a3,j,a2,b,"] += alpha * H2_sym["a3,v5,a2,c6,"] * S2["c6,j,v5,b,"];//avac****
        // temp["v3,j,a2,b,"] += alpha * H2_sym["a5,v3,c6,a2,"] * S2["c6,j,a5,b,"];//avca
        // temp["v3,j,c2,b,"] += alpha * H2_sym["a5,v3,c6,c2,"] * S2["c6,j,a5,b,"];//avcc
        // temp["a3,j,c2,b,"] += alpha * H2_sym["a3,v5,c2,c6,"] * S2["c6,j,v5,b,"];//avcc****
        // temp["v3,j,v2,b,"] += alpha * H2_sym["a5,v3,c6,v2,"] * S2["c6,j,a5,b,"];//avcv
        // temp["a3,j,v2,b,"] += alpha * H2_sym["a3,v5,v2,c6,"] * S2["c6,j,v5,b,"];//avvc****
        // temp["c3,j,a2,b,"] += alpha * H2_sym["c3,a5,a2,c6,"] * S2["c6,j,a5,b,"];//caac****
        // temp["c3,j,c2,b,"] += alpha * H2_sym["c3,a5,c2,c6,"] * S2["c6,j,a5,b,"];//cacc****
        // temp["c3,j,v2,b,"] += alpha * H2_sym["c3,a5,v2,c6,"] * S2["c6,j,a5,b,"];//cavc****
        // temp["c3,j,a2,b,"] += alpha * H2_sym["c3,v5,a2,c6,"] * S2["c6,j,v5,b,"];//cvac****
        // temp["c3,j,c2,b,"] += alpha * H2_sym["c3,v5,c2,c6,"] * S2["c6,j,v5,b,"];//cvcc****
        // temp["c3,j,v2,b,"] += alpha * H2_sym["c3,v5,v2,c6,"] * S2["c6,j,v5,b,"];//cvvc****
        // temp["v3,j,a2,b,"] += alpha * H2_sym["v5,v3,c6,a2,"] * S2["c6,j,v5,b,"];//vvca
        // temp["v3,j,c2,b,"] += alpha * H2_sym["v5,v3,c6,c2,"] * S2["c6,j,v5,b,"];//vvcc
        // temp["v3,j,v2,b,"] += alpha * H2_sym["v5,v3,c6,v2,"] * S2["c6,j,v5,b,"];//vvcv
    temp["qjsb"] -= alpha * H2["aqsm"] * T2["mjab"];
        // temp["a3,j,a2,b,"] -= alpha * H2_sym["a3,a5,c6,a2,"] * T2["c6,j,a5,b,"];//aaca****
        // temp["a3,j,c2,b,"] -= alpha * H2_sym["a5,a3,c2,c6,"] * T2["c6,j,a5,b,"];//aacc
        // temp["a3,j,v2,b,"] -= alpha * H2_sym["a3,a5,c6,v2,"] * T2["c6,j,a5,b,"];//aacv****
        // temp["v3,j,a2,b,"] -= alpha * H2_sym["a5,v3,a2,c6,"] * T2["c6,j,a5,b,"];//avac
        // temp["a3,j,a2,b,"] -= alpha * H2_sym["a3,v5,c6,a2,"] * T2["c6,j,v5,b,"];//avca****
        // temp["v3,j,c2,b,"] -= alpha * H2_sym["a5,v3,c2,c6,"] * T2["c6,j,a5,b,"];//avcc
        // temp["a3,j,c2,b,"] -= alpha * H2_sym["a3,v5,c6,c2,"] * T2["c6,j,v5,b,"];//avcc****
        // temp["a3,j,v2,b,"] -= alpha * H2_sym["a3,v5,c6,v2,"] * T2["c6,j,v5,b,"];//avcv****
        // temp["v3,j,v2,b,"] -= alpha * H2_sym["a5,v3,v2,c6,"] * T2["c6,j,a5,b,"];//avvc
        // temp["c3,j,a2,b,"] -= alpha * H2_sym["c3,a5,c6,a2,"] * T2["c6,j,a5,b,"];//caca****
        // temp["c3,j,c2,b,"] -= alpha * H2_sym["c3,a5,c6,c2,"] * T2["c6,j,a5,b,"];//cacc****
        // temp["c3,j,v2,b,"] -= alpha * H2_sym["c3,a5,c6,v2,"] * T2["c6,j,a5,b,"];//cacv****
        // temp["c3,j,a2,b,"] -= alpha * H2_sym["c3,v5,c6,a2,"] * T2["c6,j,v5,b,"];//cvca****
        // temp["c3,j,c2,b,"] -= alpha * H2_sym["c3,v5,c6,c2,"] * T2["c6,j,v5,b,"];//cvcc****
        // temp["c3,j,v2,b,"] -= alpha * H2_sym["c3,v5,c6,v2,"] * T2["c6,j,v5,b,"];//cvcv****
        // temp["v3,j,a2,b,"] -= alpha * H2_sym["v3,v5,c6,a2,"] * T2["c6,j,v5,b,"];//vvca****
        // temp["v3,j,c2,b,"] -= alpha * H2_sym["v5,v3,c2,c6,"] * T2["c6,j,v5,b,"];//vvcc
        // temp["v3,j,v2,b,"] -= alpha * H2_sym["v3,v5,c6,v2,"] * T2["c6,j,v5,b,"];//vvcv****
    temp["qjsb"] += 0.5 * alpha * L1_["xy"] * S2["yjab"] * H2["aqxs"];
    ...
    temp = ambit::BlockedTensor::build(tensor_type_, "temp", blocks);
    temp["jqsb"] -= alpha * H2["aqsm"] * T2["mjba"];
        // temp["j,a3,a2,b,"] -= alpha * H2_sym["a3,a5,c6,a2,"] * T2["c6,j,b,a5,"];//aaca****
        // temp["j,a3,c2,b,"] -= alpha * H2_sym["a5,a3,c2,c6,"] * T2["c6,j,b,a5,"];//aacc
        // temp["j,a3,v2,b,"] -= alpha * H2_sym["a3,a5,c6,v2,"] * T2["c6,j,b,a5,"];//aacv****
        // temp["j,v3,a2,b,"] -= alpha * H2_sym["a5,v3,a2,c6,"] * T2["c6,j,b,a5,"];//avac
        // temp["j,a3,a2,b,"] -= alpha * H2_sym["a3,v5,c6,a2,"] * T2["c6,j,b,v5,"];//avca****
        // temp["j,v3,c2,b,"] -= alpha * H2_sym["a5,v3,c2,c6,"] * T2["c6,j,b,a5,"];//avcc
        // temp["j,a3,c2,b,"] -= alpha * H2_sym["a3,v5,c6,c2,"] * T2["c6,j,b,v5,"];//avcc****
        // temp["j,a3,v2,b,"] -= alpha * H2_sym["a3,v5,c6,v2,"] * T2["c6,j,b,v5,"];//avcv****
        // temp["j,v3,v2,b,"] -= alpha * H2_sym["a5,v3,v2,c6,"] * T2["c6,j,b,a5,"];//avvc
        // temp["j,c3,a2,b,"] -= alpha * H2_sym["c3,a5,c6,a2,"] * T2["c6,j,b,a5,"];//caca****
        // temp["j,c3,c2,b,"] -= alpha * H2_sym["c3,a5,c6,c2,"] * T2["c6,j,b,a5,"];//cacc****
        // temp["j,c3,v2,b,"] -= alpha * H2_sym["c3,a5,c6,v2,"] * T2["c6,j,b,a5,"];//cacv****
        // temp["j,c3,a2,b,"] -= alpha * H2_sym["c3,v5,c6,a2,"] * T2["c6,j,b,v5,"];//cvca****
        // temp["j,c3,c2,b,"] -= alpha * H2_sym["c3,v5,c6,c2,"] * T2["c6,j,b,v5,"];//cvcc****
        // temp["j,c3,v2,b,"] -= alpha * H2_sym["c3,v5,c6,v2,"] * T2["c6,j,b,v5,"];//cvcv****
        // temp["j,v3,a2,b,"] -= alpha * H2_sym["v3,v5,c6,a2,"] * T2["c6,j,b,v5,"];//vvca****
        // temp["j,v3,c2,b,"] -= alpha * H2_sym["v5,v3,c2,c6,"] * T2["c6,j,b,v5,"];//vvcc
        // temp["j,v3,v2,b,"] -= alpha * H2_sym["v3,v5,c6,v2,"] * T2["c6,j,b,v5,"];//vvcv****
    temp["jqsb"] -= 0.5 * alpha * L1_["xy"] * T2["yjba"] * H2["aqsx"];
...
// temp["j,c3,v2,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,b,x"] * H2_sym["c3,a8,c9,v2,"];//cacv
    std::cout<<"in H2T2C2_sym funciton";
    C2["jqsb"] += temp["jqsb"];
    C2["qjbs"] += temp["jqsb"];
