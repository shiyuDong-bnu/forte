...
void SADSRG::H2_T2_C2_sym(BlockedTensor& H2,BlockedTensor& H2_sym, BlockedTensor& T2, BlockedTensor& S2, const double& alpha,
    ...
    // A11
    C2["pqab"] += alpha * H2["pqij"] * T2["ijab"];
        C2["a2,a3,a,b,"] += alpha * H2["a2,a3,a9,a1,"] * T2["a9,a1,a,b,"];//aaaa
        C2["a2,a3,a,b,"] += alpha * H2["a2,a3,c9,a1,"] * T2["c9,a1,a,b,"];//aaca
        C2["a2,a3,a,b,"] += alpha * H2["a2,a3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["a2,a3,a,b,"] += alpha * H2["a2,a3,c9,c1,"] * T2["c9,c1,a,b,"];//aacc
        C2["a2,v3,a,b,"] += alpha * H2["a2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//avaa
        C2["v2,a3,a,b,"] += alpha * H2["v2,a3,a9,a1,"] * T2["a9,a1,a,b,"];//****
        C2["a2,v3,a,b,"] += alpha * H2["a2,v3,a9,c1,"] * T2["a9,c1,a,b,"];//avac
        C2["v2,a3,a,b,"] += alpha * H2["v2,a3,c9,a1,"] * T2["c9,a1,a,b,"];//****
        C2["a2,v3,a,b,"] += alpha * H2["a2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//avca
        C2["v2,a3,a,b,"] += alpha * H2["v2,a3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["a2,v3,a,b,"] += alpha * H2["a2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//avcc
        C2["v2,a3,a,b,"] += alpha * H2["v2,a3,c9,c1,"] * T2["c9,c1,a,b,"];//****
        C2["c2,a3,a,b,"] += alpha * H2["c2,a3,a9,a1,"] * T2["a9,a1,a,b,"];//caaa
        C2["a2,c3,a,b,"] += alpha * H2["a2,c3,a9,a1,"] * T2["a9,a1,a,b,"];//****
        C2["c2,a3,a,b,"] += alpha * H2["c2,a3,a9,c1,"] * T2["a9,c1,a,b,"];//caac
        C2["a2,c3,a,b,"] += alpha * H2["a2,c3,c9,a1,"] * T2["c9,a1,a,b,"];//****
        C2["c2,a3,a,b,"] += alpha * H2["c2,a3,c9,a1,"] * T2["c9,a1,a,b,"];//caca
        C2["a2,c3,a,b,"] += alpha * H2["a2,c3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["c2,a3,a,b,"] += alpha * H2["c2,a3,c9,c1,"] * T2["c9,c1,a,b,"];//cacc
        C2["a2,c3,a,b,"] += alpha * H2["a2,c3,c9,c1,"] * T2["c9,c1,a,b,"];//****
        C2["c2,c3,a,b,"] += alpha * H2["c2,c3,a9,a1,"] * T2["a9,a1,a,b,"];//ccaa
        C2["c2,c3,a,b,"] += alpha * H2["c2,c3,c9,a1,"] * T2["c9,a1,a,b,"];//ccca
        C2["c2,c3,a,b,"] += alpha * H2["c2,c3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["c2,c3,a,b,"] += alpha * H2["c2,c3,c9,c1,"] * T2["c9,c1,a,b,"];//cccc
        C2["c2,v3,a,b,"] += alpha * H2["c2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//cvaa
        C2["v2,c3,a,b,"] += alpha * H2["v2,c3,a9,a1,"] * T2["a9,a1,a,b,"];//****
        C2["c2,v3,a,b,"] += alpha * H2["c2,v3,a9,c1,"] * T2["a9,c1,a,b,"];//cvac
        C2["v2,c3,a,b,"] += alpha * H2["v2,c3,c9,a1,"] * T2["c9,a1,a,b,"];//****
        C2["c2,v3,a,b,"] += alpha * H2["c2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//cvca
        C2["v2,c3,a,b,"] += alpha * H2["v2,c3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["c2,v3,a,b,"] += alpha * H2["c2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//cvcc
        C2["v2,c3,a,b,"] += alpha * H2["v2,c3,c9,c1,"] * T2["c9,c1,a,b,"];//****
        C2["v2,v3,a,b,"] += alpha * H2["v2,v3,a9,a1,"] * T2["a9,a1,a,b,"];//vvaa
        C2["v2,v3,a,b,"] += alpha * H2["v2,v3,c9,a1,"] * T2["c9,a1,a,b,"];//vvca
        C2["v2,v3,a,b,"] += alpha * H2["v2,v3,a9,c1,"] * T2["a9,c1,a,b,"];//****
        C2["v2,v3,a,b,"] += alpha * H2["v2,v3,c9,c1,"] * T2["c9,c1,a,b,"];//vvcc
    C2["pqab"] -= 0.5 * alpha * Eta1_["xy"] * T2["yjab"] * H2["pqxj"];
        // C2["a2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a2,a3,a7,a1,"];//aaaa
        // C2["a2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,a3,a7,c1,"];//aaac
        // C2["a2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,c3,a7,c1,"];//acac
        // C2["a2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a2,v3,a7,a1,"];//avaa
        // C2["v2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a3,v2,a1,a7,"];//****
        // C2["a2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,v3,a7,c1,"];//avac
        // C2["c2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,a3,a7,a1,"];//caaa
        // C2["a2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c3,a2,a1,a7,"];//****
        // C2["c2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,a3,a7,c1,"];//caac
        // C2["c2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,c3,a7,a1,"];//ccaa
        // C2["c2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,c3,a7,c1,"];//ccac
        // C2["c2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,v3,a7,a1,"];//cvaa
        // C2["v2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c3,v2,a1,a7,"];//****
        // C2["c2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,v3,a7,c1,"];//cvac
        // C2["v2,a3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,a3,a7,c1,"];//vaac
        // C2["v2,c3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,c3,a7,c1,"];//vcac
        // C2["v2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["v2,v3,a7,a1,"];//vvaa
        // C2["v2,v3,a,b,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,v3,a7,c1,"];//vvac
    C2["qpba"] -= 0.5 * alpha * Eta1_["xy"] * T2["yjab"] * H2["pqxj"];
        // C2["a3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a2,a3,a7,a1,"];//aaaa
        // C2["a3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,a3,a7,c1,"];//aaac
        // C2["c3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,c3,a7,c1,"];//acac
        // C2["v3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a2,v3,a7,a1,"];//avaa
        // C2["a3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["a3,v2,a1,a7,"];//****
        // C2["v3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["a2,v3,a7,c1,"];//avac
        // C2["a3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,a3,a7,a1,"];//caaa
        // C2["c3,a2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c3,a2,a1,a7,"];//****
        // C2["a3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,a3,a7,c1,"];//caac
        // C2["c3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,c3,a7,a1,"];//ccaa
        // C2["c3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,c3,a7,c1,"];//ccac
        // C2["v3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c2,v3,a7,a1,"];//cvaa
        // C2["c3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["c3,v2,a1,a7,"];//****
        // C2["v3,c2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["c2,v3,a7,c1,"];//cvac
        // C2["a3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,a3,a7,c1,"];//vaac
        // C2["c3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,c3,a7,c1,"];//vcac
        // C2["v3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,a1,a,b,"] * H2["v2,v3,a7,a1,"];//vvaa
        // C2["v3,v2,b,a,"] -= 0.5 * alpha * Eta1_["a7,y,"] * T2["y,c1,a,b,"] * H2["v2,v3,a7,c1,"];//vvac
    // hole-particle contractions
    std::vector<std::string> blocks;
    for (const std::string& block : C2.block_labels()) {
        if (block.substr(1, 1) == virt_label_ or block.substr(3, 1) == core_label_)
    ...
    auto temp = ambit::BlockedTensor::build(tensor_type_, "temp", blocks);
    // temp["qjsb"] += alpha * H2["aqms"] * S2["mjab"];
            temp["a2,j,a3,b,"] += alpha * H2["a5,a2,c6,a3,"] * S2["c6,j,a5,b,"];//aaca
            temp["a2,j,c3,b,"] += alpha * H2["a5,a2,c6,c3,"] * S2["c6,j,a5,b,"];//aacc
            temp["a2,j,v3,b,"] += alpha * H2["a5,a2,c6,v3,"] * S2["c6,j,a5,b,"];//aacv
            temp["c2,j,a3,b,"] += alpha * H2["a5,c2,c6,a3,"] * S2["c6,j,a5,b,"];//acca
            temp["c2,j,c3,b,"] += alpha * H2["a5,c2,c6,c3,"] * S2["c6,j,a5,b,"];//accc
            temp["c2,j,v3,b,"] += alpha * H2["a5,c2,c6,v3,"] * S2["c6,j,a5,b,"];//accv
            temp["v2,j,a3,b,"] += alpha * H2["a5,v2,c6,a3,"] * S2["c6,j,a5,b,"];//avca
            temp["v2,j,c3,b,"] += alpha * H2["a5,v2,c6,c3,"] * S2["c6,j,a5,b,"];//avcc
            temp["a2,j,c3,b,"] += alpha * H2["a2,v5,c3,c6,"] * S2["c6,j,v5,b,"];//****
            temp["v2,j,v3,b,"] += alpha * H2["a5,v2,c6,v3,"] * S2["c6,j,a5,b,"];//avcv
            temp["a2,j,a3,b,"] += alpha * H2["v5,a2,c6,a3,"] * S2["c6,j,v5,b,"];//vaca
            temp["a2,j,v3,b,"] += alpha * H2["v5,a2,c6,v3,"] * S2["c6,j,v5,b,"];//vacv
            temp["c2,j,a3,b,"] += alpha * H2["v5,c2,c6,a3,"] * S2["c6,j,v5,b,"];//vcca
            temp["c2,j,c3,b,"] += alpha * H2["v5,c2,c6,c3,"] * S2["c6,j,v5,b,"];//vccc
            temp["c2,j,v3,b,"] += alpha * H2["v5,c2,c6,v3,"] * S2["c6,j,v5,b,"];//vccv
            temp["v2,j,a3,b,"] += alpha * H2["v5,v2,c6,a3,"] * S2["c6,j,v5,b,"];//vvca
            temp["v2,j,c3,b,"] += alpha * H2["v5,v2,c6,c3,"] * S2["c6,j,v5,b,"];//vvcc
            temp["v2,j,v3,b,"] += alpha * H2["v5,v2,c6,v3,"] * S2["c6,j,v5,b,"];//vvcv
    //temp["qjsb"] -= alpha * H2["aqsm"] * T2["mjab"];
            temp["a2,j,a3,b,"] -= alpha * H2["a5,a2,a3,c6,"] * T2["c6,j,a5,b,"];//aaac
            temp["a2,j,c3,b,"] -= alpha * H2["a5,a2,c3,c6,"] * T2["c6,j,a5,b,"];//aacc
            temp["a2,j,v3,b,"] -= alpha * H2["a5,a2,v3,c6,"] * T2["c6,j,a5,b,"];//aavc
            temp["c2,j,a3,b,"] -= alpha * H2["a5,c2,a3,c6,"] * T2["c6,j,a5,b,"];//acac
            temp["c2,j,c3,b,"] -= alpha * H2["a5,c2,c3,c6,"] * T2["c6,j,a5,b,"];//accc
            temp["c2,j,v3,b,"] -= alpha * H2["a5,c2,v3,c6,"] * T2["c6,j,a5,b,"];//acvc
            temp["v2,j,a3,b,"] -= alpha * H2["a5,v2,a3,c6,"] * T2["c6,j,a5,b,"];//avac
            temp["v2,j,c3,b,"] -= alpha * H2["a5,v2,c3,c6,"] * T2["c6,j,a5,b,"];//avcc
            temp["a2,j,c3,b,"] -= alpha * H2["a2,v5,c6,c3,"] * T2["c6,j,v5,b,"];//****
            temp["v2,j,v3,b,"] -= alpha * H2["a5,v2,v3,c6,"] * T2["c6,j,a5,b,"];//avvc
            temp["a2,j,a3,b,"] -= alpha * H2["v5,a2,a3,c6,"] * T2["c6,j,v5,b,"];//vaac
            temp["a2,j,v3,b,"] -= alpha * H2["v5,a2,v3,c6,"] * T2["c6,j,v5,b,"];//vavc
            temp["c2,j,a3,b,"] -= alpha * H2["v5,c2,a3,c6,"] * T2["c6,j,v5,b,"];//vcac
            temp["c2,j,c3,b,"] -= alpha * H2["v5,c2,c3,c6,"] * T2["c6,j,v5,b,"];//vccc
            temp["c2,j,v3,b,"] -= alpha * H2["v5,c2,v3,c6,"] * T2["c6,j,v5,b,"];//vcvc
            temp["v2,j,a3,b,"] -= alpha * H2["v5,v2,a3,c6,"] * T2["c6,j,v5,b,"];//vvac
            temp["v2,j,c3,b,"] -= alpha * H2["v5,v2,c3,c6,"] * T2["c6,j,v5,b,"];//vvcc
            temp["v2,j,v3,b,"] -= alpha * H2["v5,v2,v3,c6,"] * T2["c6,j,v5,b,"];//vvvc
    //temp["qjsb"] += 0.5 * alpha * L1_["xy"] * S2["yjab"] * H2["aqxs"];
            temp["a2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,a2,a7,a3,"];//aaaa
            temp["a2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,a2,a7,c3,"];//aaac
            temp["a2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,a2,a7,v3,"];//aaav
            temp["c2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,c2,a7,a3,"];//acaa
            temp["c2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,c2,a7,c3,"];//acac
            temp["c2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,c2,a7,v3,"];//acav
            temp["v2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,v2,a7,a3,"];//avaa
            temp["a2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["a2,v5,a3,a7,"];//****
            temp["v2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,v2,a7,c3,"];//avac
            temp["v2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,a5,b,"] * H2["a5,v2,a7,v3,"];//avav
            temp["a2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,a2,a7,c3,"];//vaac
            temp["a2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,a2,a7,v3,"];//vaav
            temp["c2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,c2,a7,a3,"];//vcaa
            temp["c2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,c2,a7,c3,"];//vcac
            temp["c2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,c2,a7,v3,"];//vcav
            temp["v2,j,a3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,v2,a7,a3,"];//vvaa
            temp["v2,j,c3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,v2,a7,c3,"];//vvac
            temp["v2,j,v3,b,"] += 0.5 * alpha * L1_["a7,y,"] * S2["y,j,v5,b,"] * H2["v5,v2,a7,v3,"];//vvav
//    temp["qjsb"] -= 0.5 * alpha * L1_["xy"] * T2["yjab"] * H2["aqsx"];
            temp["a2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,a2,a3,a7,"]; //aaaa
            temp["a2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,a2,c3,a7,"]; //aaca
            temp["a2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,a2,v3,a7,"]; //aava
            temp["c2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,c2,a3,a7,"]; //acaa
            temp["c2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,c2,c3,a7,"]; //acca
            temp["c2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,c2,v3,a7,"]; //acva
            temp["v2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,v2,a3,a7,"]; //avaa
            temp["a2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["a2,v5,a7,a3,"]; //****
            temp["v2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,v2,c3,a7,"]; //avca
            temp["v2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,a5,b,"] * H2["a5,v2,v3,a7,"]; //avva
            temp["a2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,a2,c3,a7,"]; //vaca
            temp["a2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,a2,v3,a7,"]; //vava
            temp["c2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,c2,a3,a7,"]; //vcaa
            temp["c2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,c2,c3,a7,"]; //vcca
            temp["c2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,c2,v3,a7,"]; //vcva
            temp["v2,j,a3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,v2,a3,a7,"]; //vvaa
            temp["v2,j,c3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,v2,c3,a7,"]; //vvca
            temp["v2,j,v3,b,"] -= 0.5 * alpha * L1_["a7,y,"] * T2["y,j,v5,b,"] * H2["v5,v2,v3,a7,"]; //vvva
//    temp["qjsb"] -= 0.5 * alpha * L1_["xy"] * S2["ijxb"] * H2["yqis"];
            temp["a2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,a2,a9,a3,"];//aaaa
            temp["a2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,a2,a9,v3,"];//aaav
            temp["a2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,a2,c9,a3,"];//aaca
            temp["a2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a2,a8,c3,a9,"];//****
            temp["a2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,a2,c9,c3,"];//aacc
            temp["a2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,a2,c9,v3,"];//aacv
            temp["c2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,c2,a9,a3,"];//acaa
            temp["c2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,c2,a9,c3,"];//acac
            temp["c2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,c2,a9,v3,"];//acav
            temp["c2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,c2,c9,a3,"];//acca
            temp["c2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,c2,c9,c3,"];//accc
            temp["c2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,c2,c9,v3,"];//accv
            temp["v2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,v2,a9,a3,"];//avaa
            temp["v2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,v2,a9,c3,"];//avac
            temp["v2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["a9,j,x,b,"] * H2["a8,v2,a9,v3,"];//avav
            temp["v2,j,a3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,v2,c9,a3,"];//avca
            temp["v2,j,c3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,v2,c9,c3,"];//avcc
            temp["v2,j,v3,b,"] -= 0.5 * alpha * L1_["x,a8,"] * S2["c9,j,x,b,"] * H2["a8,v2,c9,v3,"];//avcv
//    temp["qjsb"] += 0.5 * alpha * L1_["xy"] * T2["ijxb"] * H2["yqsi"];
            temp["a2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,a2,a3,a9,"];//aaaa
            temp["a2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,a2,c3,a9,"];//aaca
            temp["a2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a2,a8,c9,a3,"];//****
            temp["a2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,a2,c3,c9,"];//aacc
            temp["a2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,a2,v3,a9,"];//aava
            temp["a2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,a2,v3,c9,"];//aavc
            temp["c2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,c2,a3,a9,"];//acaa
            temp["c2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,c2,a3,c9,"];//acac
            temp["c2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,c2,c3,a9,"];//acca
            temp["c2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,c2,c3,c9,"];//accc
            temp["c2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,c2,v3,a9,"];//acva
            temp["c2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,c2,v3,c9,"];//acvc
            temp["v2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,v2,a3,a9,"];//avaa
            temp["v2,j,a3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,v2,a3,c9,"];//avac
            temp["v2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,v2,c3,a9,"];//avca
            temp["v2,j,c3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,v2,c3,c9,"];//avcc
            temp["v2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["a9,j,x,b,"] * H2["a8,v2,v3,a9,"];//avva
            temp["v2,j,v3,b,"] += 0.5 * alpha * L1_["x,a8,"] * T2["c9,j,x,b,"] * H2["a8,v2,v3,c9,"];//avvc
    C2["qjsb"] += temp["qjsb"];
    C2["jqbs"] += temp["qjsb"];
