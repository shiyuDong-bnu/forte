...
C1["a2,v3,"] -= 0.5 * alpha * H2_sym["a2,v9,a7,v3,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//avav****
C1["c2,a3,"] -= 0.5 * alpha * H2_sym["c2,v9,a7,a3,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//cvaa****
C1["c2,c3,"] -= 0.5 * alpha * H2_sym["c2,v9,a7,c3,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//cvac****
C1["c2,v3,"] -= 0.5 * alpha * H2_sym["c2,v9,a7,v3,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//cvav****
C1["v2,a3,"] -= 0.5 * alpha * H2_sym["v9,v2,a3,a7,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//vvaa
C1["v2,v3,"] -= 0.5 * alpha * H2_sym["v2,v9,a7,v3,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//vvav****
C1["v2,c3,"] -= 0.5 * alpha * H2_sym["v9,v2,c3,a7,"] * T2["u,v,v9,y,"] * L2_["a7,y,u,v,"];//vvca    
    // C1["qs"] -= alpha * H2["uqms"] * T2["mvxy"] * L2_["xyuv"];
C1["a2,a3,"] -= alpha * H2_sym["a4,a2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aaca
C1["a2,c3,"] -= alpha * H2_sym["a4,a2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aacc
C1["a2,v3,"] -= alpha * H2_sym["a4,a2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aacv
C1["a2,a3,"] -= alpha * H2_sym["a2,v4,a3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avac****
C1["v2,a3,"] -= alpha * H2_sym["a4,v2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avca
C1["v2,c3,"] -= alpha * H2_sym["a4,v2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avcc
C1["a2,c3,"] -= alpha * H2_sym["a2,v4,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avcc****
C1["v2,v3,"] -= alpha * H2_sym["a4,v2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avcv
C1["a2,v3,"] -= alpha * H2_sym["a2,v4,v3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avvc****
C1["c2,a3,"] -= alpha * H2_sym["c2,a4,a3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//caac****
C1["c2,c3,"] -= alpha * H2_sym["c2,a4,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cacc****
C1["c2,v3,"] -= alpha * H2_sym["c2,a4,v3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cavc****
C1["c2,a3,"] -= alpha * H2_sym["c2,v4,a3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvac****
C1["c2,c3,"] -= alpha * H2_sym["c2,v4,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvcc****
C1["c2,v3,"] -= alpha * H2_sym["c2,v4,v3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvvc****
C1["v2,a3,"] -= alpha * H2_sym["v4,v2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvca
C1["v2,c3,"] -= alpha * H2_sym["v4,v2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvcc
C1["v2,v3,"] -= alpha * H2_sym["v4,v2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvcv
    // C1["qs"] += 0.5 * alpha * H2["uqsm"] * T2["mvxy"] * L2_["xyuv"];
C1["a2,a3,"] += 0.5 * alpha * H2_sym["a2,a4,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aaca****
C1["a2,c3,"] += 0.5 * alpha * H2_sym["a4,a2,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aacc
C1["a2,v3,"] += 0.5 * alpha * H2_sym["a2,a4,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//aacv****
C1["v2,a3,"] += 0.5 * alpha * H2_sym["a4,v2,a3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avac
C1["a2,a3,"] += 0.5 * alpha * H2_sym["a2,v4,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avca****
C1["v2,c3,"] += 0.5 * alpha * H2_sym["a4,v2,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avcc
C1["a2,c3,"] += 0.5 * alpha * H2_sym["a2,v4,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avcc****
C1["a2,v3,"] += 0.5 * alpha * H2_sym["a2,v4,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avcv****
C1["v2,v3,"] += 0.5 * alpha * H2_sym["a4,v2,v3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avvc
C1["c2,a3,"] += 0.5 * alpha * H2_sym["c2,a4,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//caca****
C1["c2,c3,"] += 0.5 * alpha * H2_sym["c2,a4,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cacc****
C1["c2,v3,"] += 0.5 * alpha * H2_sym["c2,a4,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cacv****
C1["c2,a3,"] += 0.5 * alpha * H2_sym["c2,v4,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvca****
C1["c2,c3,"] += 0.5 * alpha * H2_sym["c2,v4,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvcc****
C1["c2,v3,"] += 0.5 * alpha * H2_sym["c2,v4,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvcv****
C1["v2,a3,"] += 0.5 * alpha * H2_sym["v2,v4,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvca****
C1["v2,c3,"] += 0.5 * alpha * H2_sym["v4,v2,c3,c6,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvcc
C1["v2,v3,"] += 0.5 * alpha * H2_sym["v2,v4,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//vvcv****
    if (print_ > 3) {
        outfile->Printf("\n    Time for [H2, T2] -> C1 : %12.3f", timer.get());
    }
    dsrg_time_.add("221", timer.get());
