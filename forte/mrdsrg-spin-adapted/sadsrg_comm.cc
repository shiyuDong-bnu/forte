...
C1["a2,a3,"] -= alpha * H2_sym["v4,a2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avac****
...
C1["a2,c3,"] -= alpha * H2_sym["v4,a2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avcc****
C1["v2,v3,"] -= alpha * H2_sym["a4,v2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//avcv
C1["a2,v3,"] -= alpha * H2_sym["v4,a2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//avvc****
C1["c2,a3,"] -= alpha * H2_sym["a4,c2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//caac****
C1["c2,c3,"] -= alpha * H2_sym["a4,c2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cacc****
C1["c2,v3,"] -= alpha * H2_sym["a4,c2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,a4,v,"];//cavc****
C1["c2,a3,"] -= alpha * H2_sym["v4,c2,c6,a3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvac****
C1["c2,c3,"] -= alpha * H2_sym["v4,c2,c6,c3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvcc****
C1["c2,v3,"] -= alpha * H2_sym["v4,c2,c6,v3,"] * T2["c6,v,x,y,"] * L2_["x,y,v4,v,"];//cvvc****
