...
class SADSRG : public DynamicCorrelationSolver {
  ...
  protected:
    ...
    std::vector<double> H2_T2_C0_sym(BlockedTensor& H2,BlockedTensor& H2_sym, BlockedTensor& T2, BlockedTensor& S2,
                                 const double& alpha, double& C0);
    ...
    /// C the same function of H2_T1_C2 using symmetry
    std::vector<double> H2_T2_C0_T2small_sym(BlockedTensor& H2,BlockedTensor& H2_sym, BlockedTensor& T2, BlockedTensor& S2);
    ...
    ///  the same function of H2_T1_C1 using symmetry
    void H2_T1_C1_sym(BlockedTensor& H2_sym, BlockedTensor& T1, const double& alpha, BlockedTensor& C1);
    ...
    void H2_T2_C1_sym( BlockedTensor& H2_sym,BlockedTensor& T2, BlockedTensor& S2, const double& alpha,
                  BlockedTensor& C1);
    ...
    /// the same function of H2_T1_C2 using symmetry
    void H2_T1_C2_sym(BlockedTensor& H2_sym, BlockedTensor& T1, const double& alpha, BlockedTensor& C2);
    ...
    void H2_T2_C2(BlockedTensor& H2, BlockedTensor& T2, BlockedTensor& S2, const double& alpha,
                  BlockedTensor& C2);
    // the same function of H2_T2_C2 using symmetry
    void H2_T2_C2_sym(BlockedTensor& H2_sym,BlockedTensor& T2, BlockedTensor& S2, const double& alpha,
                      BlockedTensor& C2);
